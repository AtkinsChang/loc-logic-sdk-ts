...
declare class RailwayError extends Error {
    ...
    constructor(name: string, message: string, logicPermanentIdentity: string, logicRevision: number);
}
...
declare class DatabaseAgent {
    connect({ databaseDriver, connectionString, connection, }: Database.Config): Promise<DatabaseClient>;
}
...
declare class FileStorageAgent {
    ...
    simplePut(url: URL | string, data: Uint8Array | string, options?: FileStorage.PutOptions): Promise<number>;
...
declare class HttpAgent {
    send(request: Http.Request, config: Http.Config | null): Promise<Http.Response>;
    get(url: string, headers: Record<string, string>, contentType: Http.ContentType, body?: Uint8Array | null, config?: Http.Config | null): Promise<Http.Response>;
    post(url: string, headers: Record<string, string>, contentType: Http.ContentType, body: Uint8Array | null, config?: Http.Config | null): Promise<Http.Response>;
    patch(url: string, headers: Record<string, string>, contentType: Http.ContentType, body: Uint8Array | null, config?: Http.Config | null): Promise<Http.Response>;
    put(url: string, headers: Record<string, string>, contentType: Http.ContentType, body: Uint8Array | null, config?: Http.Config | null): Promise<Http.Response>;
    delete(url: string, headers: Record<string, string>, contentType: Http.ContentType, body: Uint8Array | null, config?: Http.Config | null): Promise<Http.Response>;
}
declare namespace Http {
    ...
    class Request {
        ...
        constructor(method?: Method, url?: string, headers?: Record<string, string>, contentType?: ContentType, body?: Uint8Array | null);
...
declare class LocalStorageAgent {
    ...
    putByteArray(key: string, value: Uint8Array | string, timeout?: number): Promise<void>;
...
declare class SmtpAgent {
    connect(host: string, username?: string, password?: string): Promise<SmtpAgentHub>;
}
